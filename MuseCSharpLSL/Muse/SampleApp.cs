...
public class SampleApp : MonoBehaviour {
    ...
    public void userSelectedMuse() {
        ...
        Console.WriteLine("Selected muse = " + userPickedMuse);
    }
    ...
    public void connect() {        
        ...
        Console.WriteLine("Connecting to " + userPickedMuse);
    ...
    void Start () {
//ifUNITY_IPHONE
        var muse = new LibmuseBridge();
//elifUNITY_ANDROID
        //muse = new LibmuseBridgeAndroid();
//endif
        Console.WriteLine("Libmuse version = " + muse.getLibmuseVersion());
